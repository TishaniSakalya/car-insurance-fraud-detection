...
# Load your dataset
train_data_new <- read.csv("C:/Users/Hiruni/OneDrive/Desktop/train_set.csv")
...
write.csv(train_data_encoded, "C:/Users/Hiruni/OneDrive/Desktop/train_encoded.csv", row.names = FALSE)
