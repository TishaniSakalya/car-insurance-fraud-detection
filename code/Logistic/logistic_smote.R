...
write.csv(test_set, "C:/Users/sakal/Documents/ISMF/Sem 6/ST 3082-Statistical Learning I/Advanced Analysis project/predicted_test_results_smote.csv", row.names = FALSE)
