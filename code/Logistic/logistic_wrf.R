...
# ---- Read Training Data ----
train_new <- read.csv("C:/Users/sakal/Documents/ISMF/Sem 6/ST 3082-Statistical Learning I/Advanced Analysis project/train_wrf_without_OHE.csv")
...
write.csv(test_set, "C:/Users/sakal/Documents/ISMF/Sem 6/ST 3082-Statistical Learning I/Advanced Analysis project/predicted_test_results_wrf.csv", row.names = FALSE)
